resource "aws_instance" "docker-instance" { # this instance will not be create when 'terraform apply' is called 
  count         = var.docker_instance_count # 0 means not to create. Jenkins will create this instance
